# Generated by Django 4.2.27 on 2025-12-18 01:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text="User's available balance in dollars", max_digits=12)),
                ('reserved_balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Funds locked in open buy orders', max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'created_at'], name='predictions_user_id_13b072_idx'), models.Index(fields=['type', 'created_at'], name='predictions_type_50a295_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='trade',
